...
**1.  Write a sentence describing a key takeaway for each graph shown in the report.**
  ...
  **d.  Graph #4: Front Office Reachability % and Avg Time to Answer (goal <8 seconds)**
  ...
  - Throughout the year, the "Front Office Reachability" stayed remarkably high (consistently above 97%) and the average answer time hovered around 8 to 10 seconds (slightly above the goal of 8 second) suggesting the team maintain solid, open lines of communication.
